...
export const selectedColor = (theme, inputSelectedColor) => {
  return {
    color: inputSelectedColor
      ? inputSelectedColor
      : theme.autoComplete.selectedInputColor,
  };
};
  ...
  return {
    ...
    valueContainer: {
      ...(theme.autoComplete?.valueContainer ||
        defaultTheme.autoComplete.valueContainer),
      "& input": {
    ...
    selectStyles: {
      singleValue: (base) => ({
        ...base,
        color:
          theme.palette?.text?.primary || defaultTheme.palette.text.primary,
      }),
      input: (base) => ({
        ...base,
        color:
